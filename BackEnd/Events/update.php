        ...
        <div class="container-lg">
                <div class="p-5 row justify-content-center">
                    <form action="EventsController.php" method="POST">
                        ...
                        <div class="mb-3">
                            <label  class="form-label">Event_title</label>
                            <input type="text" class="form-control" value="<?= $model->event_title?>" placeholder="Enter Event Title" name='event_title'>
                        </div>
                        <div class="mb-3">
                            <label  class="form-label">Event Details</label>
                            <input type="text" class="form-control" value="<?= $model->event_details?>" placeholder="Enter Event Details" name='event_details'>
                        </div>
                        <div class="mb-3">
